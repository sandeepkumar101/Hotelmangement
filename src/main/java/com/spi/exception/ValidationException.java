...
public class ValidationException extends WebApplicationException {
	...
	public ValidationException(Set<? extends ConstraintViolation<?>> violations) {
		...
		for (ConstraintViolation<?> constraintViolation : violations) {
			...
			error.setPropertyName(constraintViolation.getPropertyPath()
					.toString());
			error.setPropertyValue(constraintViolation.getInvalidValue() != null ? constraintViolation
					.getInvalidValue().toString() : null);
			errors.add(error);
		}
	}
