 ...
 * @param {function}
 */
javaRest.user.create = function (firstName, emailAddress, password, lastName, addressLine1, addressLine2, city, state, pinCode, callback) {
  javaRest.post(
    'user/signup',
    { user :
      {
...
javaRest.user.route = function (email, password, callback) {
